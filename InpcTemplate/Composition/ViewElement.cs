...
namespace NorthHorizon.Samples.InpcTemplate.Composition
{
    ...
    public sealed class ViewElement : Control
    {
        ...
        {
            var metadata = (ViewComponentPropertyMetadata)e.Property.DefaultMetadata;
        ...
        private abstract class ViewComponentPropertyMetadata : PropertyMetadata
        {
            ...
            protected ViewComponentPropertyMetadata(bool isInjected, DependencyPropertyChangedEventHandler propertyChangedCallback)
        ...
        {
            public ViewPropertyMetadata(bool isInjected, DependencyPropertyChangedEventHandler propertyChangedCallback) 
        ...
        {
            public ViewModelPropertyMetadata(bool isInjected, DependencyPropertyChangedEventHandler propertyChangedCallback) 
                : base(isInjected, propertyChangedCallback) {}
